	...
	*/
	class User implements Crud, Authenticator
	{
		...
		public function save()
		{
			...
			$res = mysqli_query($this->con->conn, "INSERT INTO user(first_name, last_name, user_city, username, password, user_utc, offset) VALUES('$fn', '$ln', '$city', '$uname', '$pass', '$utc', '$offset')") or die("Error " . mysqli_error($this->con->conn));
