...
<body>
	<form method="post" name="user_details" id="user_details" onsubmit="return validateForm()" action="<?=$_SERVER['PHP_SELF']?>">
		<table align="center">
			...
			<input type="hidden" name="utc_timestamp" id="utc_timestamp" value="<?php  echo $l10nDate->format('Y-m-d H:i:s');?>">
			<input type="hidden" name="time_zone_offset" id="time_zone_offset" value="<?php  echo $l10nDate->format('Y-m-d H:i:s');?>">
			<tr>
				<td>
